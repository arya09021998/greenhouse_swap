...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
  ...
  console.log('debug->farms', farmsLP)
    ...
    (farmsToDisplay: Farm[]): FarmWithStakedValue[] => {
      let farmsToDisplayWithAPR: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        const { cakeRewardsApr, lpRewardsApr } = isActive
          ? getFarmApr(new BigNumber(farm.poolWeight), cakePrice, totalLiquidity, farm.lpAddresses[ChainId.MAINNET], new BigNumber(farm.chronicPerBlock))
    ...
    <>
      <PageHeader>
        <Heading as="h1" scale="xxl" color="primary" mb="24px">
          ...
          {tokenMode ? t('Grinder') : t('Cultivate')}
        </Heading>
